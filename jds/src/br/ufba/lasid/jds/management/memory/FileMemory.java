 ...
 * @author aliriosa
 */
public class FileMemory extends RandomAccessFile implements IPersistentMemory{
    Properties options = new Properties();
    PageIndexList modOffsets = new PageIndexList();
    
    public FileMemory(File file, String mode) throws FileNotFoundException {
        super(file, mode);
    }

    public FileMemory(String name, String mode) throws FileNotFoundException {
        super(name, mode);
    }
