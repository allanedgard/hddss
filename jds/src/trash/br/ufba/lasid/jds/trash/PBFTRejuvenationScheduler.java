...
public abstract class PBFTRejuvenationScheduler implements IScheduler, ITask{

    protected String REJUVENATIONID = "__PBFTRejuvenarionSchedulerREQUESTID";
    protected PBFT2 protocol = null;
    IScheduler scheduler = null;

    public PBFTRejuvenationScheduler(PBFT2 protocol, IScheduler scheduler){
...
//        request.put(REJUVENATIONID, getRequestID(request));
    ...
    public long getRequestTimeout(PBFTMessage request){
        return -1L;//((Long)(request.get(getTAG()))).longValue();
    }
