 ...
 * @author aliriosa
 */
public class PersistentStateManager extends BaseStateManager implements IPersistentStateManager{

    String storageID = "";
    Properties options = new Properties();
    long checkpointID = 0;
    
    public PersistentStateManager(Properties options){
        if(options != null){
    ...
    public void checkpointMeta(long checkpointID) throws Exception {
       ...
       * Checkpoint state variables descriptors
       ######################################################*/
        ...
        vptree.stamp(checkpointID, vStorage, true);
       ...
       * Checkpoint the pointers for free space.
       ######################################################*/
        ...
        fptree.stamp(checkpointID, fStorage, true);
    ...
    public void checkpointData(long checkpointID, boolean execDownloadData) throws Exception {
       ...
       * Checkpoint the state data.
       ######################################################*/
        ...
        dptree.stamp(checkpointID, currentState.getMemory(), execDownloadData);
    ...
    private IMemory getStorage(String _storageID) throws Exception{
        ...
        _options.put(JDSConfigurator.PersistentStorageID, _storageID);
        IMemory _memory = JDSConfigurator.create(JDSConfigurator.PersistentMemoryProvider, _options);
        return _memory;
    }
...
//        String volatiteStateData = options.getProperty( JDSConfigurator.hasAVolatileStateMemory,
//                                                        "true");
//
//        return Boolean.parseBoolean(volatiteStateData);
    ...
    public long getMaximumCacheSize(){
        String mcs = options.getProperty( JDSConfigurator.MaximumCacheSize,
                                          "256" );
    ...
    public int getBTreeStructureMaximumDepth(){
        String btsmd = options.getProperty( JDSConfigurator.BTreeStructureMaximumDepth,
                                            "4" );
    ...
    public int getBTreeStructureOrder(){
        String btsmd = options.getProperty( JDSConfigurator.BTreeStructureOrder,
                                            "256" );
