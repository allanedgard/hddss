 ...
 * @author allan
 */
public class objetoConsensoTimedCB implements Comparable<objetoConsensoTimedCB> {
    java.util.ArrayList UnstableMensagensEnviadas;
    ConjuntoInteiro down;
    ConjuntoInteiro live;
    ConjuntoInteiro uncertain;
    
    objetoConsensoTimedCB() {
        
    }
    
     @Override public boolean equals( Object aThat ) {
     if ( this == aThat ) return true;
     if ( !(aThat instanceof objetoConsensoTimedCB) ) return false;

     objetoConsensoTimedCB that = (objetoConsensoTimedCB)aThat;
     return
       ( 
   ...
   @Override public int hashCode() {
    ...
    public int compareTo( objetoConsensoTimedCB aThat ) {
        final int BEFORE = -1;
        final int EQUAL = 0;
        final int AFTER = 1;
