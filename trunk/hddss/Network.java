...
//        long at = delay();
    ...
    public boolean isBroadcast(Mensagem msg){
        return (msg.destinatario == conteiner.n);
    }

    public boolean isRelay(Mensagem msg){
        return (msg.relayTo != -1);
    }

    public void relay(Mensagem msg, double atraso){
    ...
    public void unicast(Mensagem msg, double atraso){
        unicasts[msg.tipo]++;
        if (isLoopback(msg)) {
            loopback(msg);
            return;
    ...
    public void transfer(int p_i, int p_j, Mensagem msg, double atraso){
        Channels[p_i][p_j].entregaMensagem(msg, atraso);
    }

    public void broadcast(Mensagem msg, double atraso){
